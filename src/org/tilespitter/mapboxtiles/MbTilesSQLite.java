...
public class MbTilesSQLite extends SQLiteOpenHelper {
	...
	private final static String CREATE_TILES = "CREATE TABLE "  + TABLE_TILES + "( " +
	...
	private final static String CREATE_METADATA = "CREATE TABLE" +  TABLE_METADATA + "( " +
	...
	")";
	private final static String INDEX_METADATA = "CREATE UNIQUE INDEX name ON " + TABLE_METADATA + "( " + 
		COL_METADATA_NAME +
	")";	
